...
clc;
popsize =100;
minlayer = [-60 -45	-75	60	90	75	45	0];%stacking sequence of the thinnest subregion
thickpredict = [8 9 9 9];%Prediction of thickness, represented by half of the thickness
...
difthick = max(thickpredict)-minthick+1;%The difference in thickness between the thickest and thinnest layers
